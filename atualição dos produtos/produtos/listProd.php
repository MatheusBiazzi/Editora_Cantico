            ...
            <table class="tbProd">
                ...
                <?php
                    while($user_data =mysqli_fetch_assoc($result)){
                        ...
                        echo"<td><a href='#?cod_produto=$user_data[cod_pessoa]'><img src='../../estilos/icons/escrever.png'></a> </td>";
                        echo "<td><a href='# ?cod_produto={$user_data['cod_pessoa']}' onclick='return confirmarExclusao(event);'><img src='../../estilos/icons/excluir.png' alt='Excluir'/></a></td>";
                        echo"</tr>";
                    }
                ?>
            </table>
